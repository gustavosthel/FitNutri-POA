            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div class="text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="goal-setup.html" class="bg-white text-primary px-8 py-3 rounded-lg font-semibold hover:bg-neutral transition-colors">
                            🎯 Definir Metas
                        </a>
                        <a href="balance.html" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary transition-colors">
        ...
        <div class="py-20 bg-neutral">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white p-8 rounded-xl card-shadow text-center hover:transform hover:scale-105 transition-all cursor-pointer" onclick="location.href='goal-setup.html'">
                    ...
                    <div class="bg-white p-8 rounded-xl card-shadow text-center hover:transform hover:scale-105 transition-all cursor-pointer" onclick="location.href='nutrition.html'">
                    ...
                    <div class="bg-white p-8 rounded-xl card-shadow text-center hover:transform hover:scale-105 transition-all cursor-pointer" onclick="location.href='activity.html'">
                    ...
                    <div class="bg-white p-8 rounded-xl card-shadow text-center hover:transform hover:scale-105 transition-all cursor-pointer" onclick="location.href='balance.html'">
                    ...
                    <div class="bg-white p-8 rounded-xl card-shadow text-center hover:transform hover:scale-105 transition-all cursor-pointer" onclick="location.href='ai-recommendations.html'">
